...
#       print "\n".join(lines)
        ...
        self.assertEqual(lines[9] , u'  ')
        self.assertEqual(lines[10], u'[X] チェック済み')
        self.assertEqual(lines[11], u'1. 数字付１')
        self.assertEqual(lines[12], u'2. 同じく２')
        self.assertEqual(lines[13], u'3. おまけに３')
        self.assertEqual(lines[14], u'')
        self.assertEqual(lines[15], u'1. list2-1')
        self.assertEqual(lines[16], u'2. list2-2')
        self.assertEqual(lines[17], u'')
        self.assertEqual(lines[18], u'> インデント')
        self.assertEqual(lines[19], u'> インデント２')
        self.assertEqual(lines[20], u'')
        self.assertEqual(lines[21], u'> > ２重インデント            ２重インデント２')
        self.assertEqual(lines[22], u'')
        self.assertEqual(lines[23], u'')
        self.assertEqual(lines[24], u'')
        self.assertEqual(lines[25], u'normal line')
        self.assertEqual(lines[26], u'')
        self.assertEqual(lines[27], u'    def haruhi(self):')
        self.assertEqual(lines[28], u'        pass<a href="hoge"> test </a>')
        self.assertEqual(lines[29], u'        > >')
        self.assertEqual(lines[30], u'')
        self.assertEqual(lines[31], u'### asuka.langley')
        self.assertEqual(lines[32], u'test backtick')
        self.assertEqual(lines[33], u'`import markdown`test')
    # }}}
